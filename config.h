...
static const char *altbarcmd        = "$HOME/.local/bin/polybar.sh"; /* Alternate bar launch command */
...
static const char col_red[]        = "#ff6262";
...
static const char *volupcmd[] = {"volume.sh", "5%+"};
static const char *voldowncmd[] = {"volume.sh", "5%-"};
